...
node['ceph']['config']['global']['mon osd full ratio']=0.85
node['ceph']['config']['global']['mon osd nearfull ratio']=0.70
node['ceph']['config']['global']['osd backfill full ratio']=0.70
